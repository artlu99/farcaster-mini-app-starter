...
app.get("/slides", (c) => {
  const slides: Slide[] = [
    ...
    },
    {
      ...
      fid: 6546,
      imgUrl:
        "https://media.decentralized-content.com/-/rs:fit:1920:1920/aHR0cHM6Ly9tYWdpYy5kZWNlbnRyYWxpemVkLWNvbnRlbnQuY29tL2lwZnMvYmFmeWJlaWhtcHJkZmppNW1lZXZmdWpkeTZzeXVubXh4enF5YjJiZzU3a3dzMnN6NndrNXh3Z290b2E",
